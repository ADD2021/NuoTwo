...
namespace ZzaDesktop.Customers
{
    class CustomerListViewModel : BindableBase
    {
        ...
        public CustomerListViewModel(ICustomersRepository repo)
        {
            ...
            DeleteDeviceCommand = new RelayCommand<Customer>(DeleteDevice);
        ...
        private void FilterCustomers(string searchInput)
        {
            ...
            else
            {
                Customers = new ObservableCollection<Customer>(
                    _allCustomers.Where(c => c.Address.ToLower().Contains(searchInput.ToLower())));
            }
        }
        ...
        public RelayCommand<Customer> DeleteDeviceCommand { get;  set; }
